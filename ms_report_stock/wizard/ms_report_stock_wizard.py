...
class MsReportStock(models.TransientModel):
    ...
    def print_excel_report(self):
        ...
        report_name = 'Rapport de stock By freePros'
        filename = '%s %s'%(report_name,date_string)
        
        columns = [
            ('No', 5, 'no', 'no'),
            ('Article', 30, 'char', 'char'),
            ('Catégories d\'articles', 20, 'char', 'char'),
            ('Emplacements', 30, 'char', 'char'),
            ('date d\'entrée en stock', 20, 'char', 'char'),
            ('Âge du Stock', 20, 'number', 'char'),
            ('Stock total', 20, 'float', 'float'),
            ('Disponible', 20, 'float', 'float'),
            ('Réservé', 20, 'float', 'float'),
        ]
